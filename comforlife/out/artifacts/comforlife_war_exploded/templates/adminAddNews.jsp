            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="/struts/addNews" method="post">
                            <div class="form-group">
                                <label for="title">新聞標題</label>
                                <input type="text" name="Title" class="form-control" id="title" placeholder="標題">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="summary" class="form-control" id="profile" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="trumbowyg">詳細新聞</label>
                                <textarea name="Desc" id="trumbowyg"></textarea>
                            </div>
