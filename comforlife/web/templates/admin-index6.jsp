...
<html lang="en">
<%
    List userInfo = (List)request.getAttribute("admin6UserInfo");
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <%
                                    ...
                                    for (int i=0; i<size; i++){
                                        u = (UserEntity)userInfo.get(i);
                                        out.println(
                                                "<tr>"+
                                                "<td>"+u.getId()+"</td>"+
                                                "<td>"+u.getName()+"</td>"+
                                                "<td>"+
                                                "<button type='button' class='btn btn-info btn-xs user-focus'>查看</button>"+
                                                "</td>"+
                                                        "<td>"+
                                                        "<button type='button' class='btn btn-info btn-xs user-house'>查看</button>"+
                                                        "</td>"+
                                                        "<td>"+
                                                        "<button type='button' class='btn btn-info btn-xs user-action'>查看</button>"+
                                                        "<td>"+
                                                        "<button type='button' class='btn btn-danger btn-xs kill-user'>kill</button>"+
                                                        "</td></tr>"
                                        );
                                    }
                                %>
