...
<html><head>
    ...
    <meta charset="utf-8">
    <title><% out.println(home.getConName());%></title>
    ...
    <div class="shop-first-row">
        <div class="simg-container">
            <div class="simg-hero-cont">
                <img class="simg-hero" src="assets/images/6.jpg">
            ...
            <ul class="simg-list">
                <li class="hover"><img src="assets/images/6.jpg"></li>
            </ul>
        </div>
        <div class="shop-right-container">
            ...
            <div class="shop-description">
                <p>
                    價格:<% out.println(home.getUnitPrice()); %>
                </p>
                <hr>
                <p>
                ...
                <hr>
                <p>
                    房屋概況:<% out.println("楼层"+home.getFloor()+", 面积"+home.getArea());%>

                </p>
                <hr>
                <p>
                    配套設施:<% out.println("还是什么都没有哟");%>
                </p>
                <hr>
                <p>
                    聯繫人:<% out.println(user.getPhone()); %>
                </p>
            </div>
        </div>
    </div>
...
<div class="information">
        ...
        <div class="info-table">
            <div class="info-cell">
                <p class="info-type">物業類型</p>
                <p class="info-value">住宅</p>
            </div>
            <div class="info-cell">
                <p class="info-type">物業類型</p>
                <p class="info-value">住宅</p>
