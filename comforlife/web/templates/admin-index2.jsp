...
<html lang="en">
<%
    List news=(List)request.getAttribute("admin2Info");
    if (news.size()!=1)
        response.sendRedirect("/templates/failed.jsp");
    NewsEntity e = (NewsEntity)news.get(0);
%>
                        ...
                        <div class="dataTable_wrapper">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <%
                                    out.println(
                                            "<tr>"+
                                                    ...
                                                    "<label>"+
                                                    "<input type='checkbox' class='zd' checked><span></span>"+
                                                    "</label></div></td>"+
                                                    "<td>"+
                                                    "<button type='button' class='btn btn-danger btn-xs news-delete'>delete</button>"+
                                                    "</td></tr>"
                                    );
                                %>
                                ...
                                <%--<tr>--%>
                                    ...
                                    <%--</td>--%>
                                    <%--<td>--%>
                                        <%--<button type="button" class="btn btn-danger btn-xs news-delete">刪除</button>--%>
                                    <%--</td>--%>
